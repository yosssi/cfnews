...
var SearchParams = []map[string]string{
	map[string]string{"q": "\"クラウドファンディング\"+AND+\"http://\"", "result_type": "recent", "count": "100"},
	map[string]string{"q": "\"クラウドファンディング\"+AND+\"https://\"", "result_type": "recent", "count": "100"},
	map[string]string{"q": "\"crowdfunding\"+AND+\"http://\"", "result_type": "recent", "count": "100"},
	map[string]string{"q": "\"crowdfunding\"+AND+\"https://\"", "result_type": "recent", "count": "100"},
}
